 ...
 * 
 * Compile : gcc -no-pie -fno-PIE -O0 -g -o house_of_husk_2_glibc-2.39 house_of_husk_2_glibc-2.39.c
 */
...
int main(void)
{
	...
	*(size_t *)(p4 + ('X' - 2)) = backdoor_addr;
	...
	puts("[*] Setup complete for House of Husk (Attack Chain 2) in glibc-2.39");
